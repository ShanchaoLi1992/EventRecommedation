...
public class TicketMasterClient {
	...
	private static final String API_KEY = "GNMs4eTp2aoPcTEtKyEzmmJVepYQapsM";
	...
	public List<Item> search(double lat, double lon, String keyword) {
		...
		String query = String.format("apikey=%s&geoPoint=%s&keyword=%s&radius=%s", API_KEY, geoPoint, keyword, DEFAULT_RADIUS);
	...
	private String getAddress(JSONObject event) {
